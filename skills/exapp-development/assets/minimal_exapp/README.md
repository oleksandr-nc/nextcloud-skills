...
- `appinfo/info.xml` - the manifest; see
  [exapp-contract.md](../../references/exapp-contract.md) for the reference.
...
[dev-environment.md](../../../nextcloud-dev-setup/references/dev-environment.md) and
[exapp-development.md](../../references/exapp-development.md).
